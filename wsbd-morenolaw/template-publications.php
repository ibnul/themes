  ...
  <div class="col-xs-12 col-sm-6 col-md-6">  
   <div class="row">
    <h3 class="archive-tab se-posts">
     <a href="#"><?php _e('Speaking Engagements', 'morenolaw'); ?></a>
   </h3>
 </div>
</div>
<div class="col-xs-12 col-sm-6 col-md-6">  
 <div class="row">
  <h3 class="archive-tab publications-posts">
   <a href="#" class="active"><?php _e('Publications', 'morenolaw'); ?></a>
  </h3>
</div>
</div>
<div id="se-posts" style="display: none;">
<?php $i=10; ?>
<?php
$args = array(
  'post_type' => 'speaking_engagements',
...
<?php if($query->have_posts()) : while($query->have_posts()) : $query->the_post(); ?>
  ...
  <div id="publications-posts" style="display: block;">
<?php $i=0; ?>
<?php
$args = array(
  'post_type' => 'moreno_publications',
...
<?php if($query->have_posts()) { while($query->have_posts()) { $query->the_post(); ?>
  ...
  <?php } ?>
	<?php echo do_shortcode('[ajax_load_more id="se-posts" container_type="div" post_type="moreno_publications" posts_per_page="6" post_format="standard" scroll="false" transition_container="false" button_label="Load More"]'); ?>
  <?php } else { ?>
    I'm not sure what you're looking for.
  <?php } ?>
  <?php wp_reset_postdata(); ?>
